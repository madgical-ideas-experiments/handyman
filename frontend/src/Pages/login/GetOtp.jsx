      ...
      <div className="card">
        ...
        <div className="items">
          ...
          <div className="get_otp">
            <div className="otp">
              <input type="text" name="otp" value="" placeholder="4" required />
            </div>
            <div className="otp">
              <input type="text" name="otp" value="" placeholder="7" required />
            </div>
            <div className="otp">
              <input type="text" name="otp" value="" placeholder="9" required />
            </div>
            <div className="otp">
              <input type="text" name="otp" value="" placeholder="0" required />
            </div>
          </div>
